<?php
include ('assistant_header.php');
?>

<div class="container">

    <!-- the next line acts like the action of the form method..
    as soon as submit button is clicked, it will go the the assistantlogin controller and access
    the assistant_login function of that controller -->
    <?php
    echo form_open('assistantlogin/assistant_login', ['class'=>'form-horizontal']);
    ?>
    <fieldset>
        <legend>Assistant Login</legend>
